        ...
        <div class="flex flex-wrap items-center justify-between p-3">
            ...
            <div :class="['w-full md:flex md:w-auto', isOpen ? 'block' : 'hidden']" id="navbar">
                <div class="flex flex-col md:flex-row md:items-center md:space-x-4 space-y-2 md:space-y-0 px-8">
                    ...
                    <a class="text-black bg-white hover:bg-bggray border focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center"
                        href="https://demo.thingsboard.io/signup">Crear cuenta</a>
                </div>
            </div>
        </div>
    </nav>
